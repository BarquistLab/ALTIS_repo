...
Estimate number of samples required for infection assay
...
fwrite(df_40samples, paste0(res_dir, "sim40samples_run2.csv"), quote=T)
```

```{r}
df_40samples <- fread(paste0(res_dir, "sim40samples.csv"), data.table=F, quote="\"")
...
create long data frame from L10/L30 libraries
